  ...
  return (
    ...
    >
      ...
      <div className="border-b border-[#D5D5D5]">
        <div className="max-w-[1200px] mx-auto px-4 py-2 grid grid-cols-3 items-center">

          {/* Date — gauche (cachée sur mobile) */}
          <span className="text-xs text-[#6B6B6B] hidden sm:block truncate" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>
            {formattedDate}
          </span>
          ...
          <div className="flex items-center gap-1 justify-end">
            ...
            {/* Recherche — touch target ≥ 44px */}
            <Link
              href="/recherche"
              className="inline-flex items-center justify-center min-w-[44px] min-h-[44px] text-[#1D1D1B] hover:text-[#E9322D] transition-colors"
            ...
            <div className="hidden md:flex items-center">
              {userName ? (
                <Link
                  href="/espace-perso"
                  className="text-xs font-semibold text-[#1D1D1B] hover:text-[#E9322D] transition-colors uppercase tracking-wide truncate max-w-[120px] min-h-[44px] inline-flex items-center"
                ...
                <Link
                  href="/auth/signin"
                  className="text-xs font-semibold text-[#1D1D1B] hover:text-[#E9322D] transition-colors uppercase tracking-wide min-h-[44px] inline-flex items-center"
                  style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}
                >
                  Se connecter
                </Link>
            ...
            <button
              className="md:hidden inline-flex items-center justify-center min-w-[44px] min-h-[44px] text-[#1D1D1B] hover:text-[#E9322D] transition-colors"
